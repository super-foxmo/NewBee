...
import foxmo.common.cloud.newbee.util.MD5Util;
import foxmo.user.cloud.newbee.config.annotation.TokenToAdminUser;
import foxmo.user.cloud.newbee.controller.param.AdminLoginParam;
import foxmo.user.cloud.newbee.controller.param.UpdateAdminNameParam;
import foxmo.user.cloud.newbee.controller.param.UpdateAdminPasswordParam;
import foxmo.user.cloud.newbee.entity.AdminUser;
import foxmo.user.cloud.newbee.service.AdminUserService;
...
public class NewBeeMallCloudAdminUserController {
    ...
    public Result<LoginAdminUser> getAdminUserByToken(@PathVariable("token") String token) {
