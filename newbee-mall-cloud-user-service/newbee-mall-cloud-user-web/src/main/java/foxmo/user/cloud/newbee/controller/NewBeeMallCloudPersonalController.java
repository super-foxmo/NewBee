 ...
 * 版权所有，侵权必究！
 */
package foxmo.user.cloud.newbee.controller;
...
import foxmo.common.cloud.newbee.util.BeanUtil;
import foxmo.common.cloud.newbee.util.NumberUtil;
import foxmo.user.cloud.newbee.config.annotation.TokenToMallUser;
import foxmo.user.cloud.newbee.controller.param.MallUserLoginParam;
import foxmo.user.cloud.newbee.controller.param.MallUserRegisterParam;
import foxmo.user.cloud.newbee.controller.param.MallUserUpdateParam;
import foxmo.user.cloud.newbee.controller.vo.NewBeeMallUserVO;
import foxmo.user.cloud.newbee.entity.MallUser;
import foxmo.user.cloud.newbee.service.NewBeeMallUserService;
